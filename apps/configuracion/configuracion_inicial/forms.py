...
class ConfiEmpresaForm(forms.ModelForm):
    class Meta:
        ...
        exclude = ['id_confi']
        widgets = {
            'nombre_empresa' : forms.TextInput(attrs={'class':'form-control', 'autocomplete': 'off','name': 'nombre_empresa', 'placeholder': 'Nombre de la empresa', 'required': 'required','onkeyup':'aceptarLetras(this)'}),
            ...
            'cuidad' : forms.TextInput(attrs={'class':'form-control', 'autocomplete': 'off','name': 'cuidad', 'placeholder': 'Cuidad de la empresa', 'required': 'required','onkeyup':'aceptarLetras(this)'}),
            'telefono' : forms.TextInput(attrs={'class':'form-control', 'autocomplete': 'off','name': 'telefono', 'placeholder': 'Telefono de la empresa', 'required': 'required','onkeyup':'aceptarNumeros(this)'}),
            ...
            'fecha_fin_timbrado': forms.TextInput(attrs={'class': 'form-control',
                                            ...
                                            'autocomplete': 'off',
                                            'required': 'required'}),
            'nro_timbrado': forms.TextInput(attrs={'class': 'form-control', 'name': 'nro_timbrado','id':'nro_timbrado','autocomplete': 'off','placeholder': 'Escriba el nro del timbrado','required':'required','onkeyup':'aceptarNumeros(this)'}),
            'ruc_empresa': forms.TextInput(attrs={'class': 'form-control', 'name': 'ruc_empresa','autocomplete': 'off','placeholder': 'Escriba el RUC','required':'required','onkeyup':'aceptarNumeros(this)'}),
            'apertura_caja_inicial' : forms.TextInput(attrs={'class':'form-control', 'autocomplete': 'off','name': 'apertura_caja_inicial', 'placeholder': 'Ingrese el monto inicial de la caja', 'required': 'required','onkeyup':'aceptarNumeros(this)'}),
